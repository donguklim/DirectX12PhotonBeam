...
void PhotonBeamApp::BuildShadersAndInputLayout()
{
    ...
    m_rayTraceShaders["rayPMInt"] = raytrace_helper::CompileShaderLibrary(L"Shaders\\ray_participating_media_int.hlsl");
    m_rayTraceShaders["rayPMAnyHit"] = raytrace_helper::CompileShaderLibrary(L"Shaders\\ray_participating_media_anyhit.hlsl");
